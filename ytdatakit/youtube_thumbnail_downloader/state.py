...
from ytdatakit.youtube_thumbnail_downloader.config import default_thumbnail_raw_urls, default_thumbnail_savepaths, default_thumbnail_location, default_thumbnail_data_entries, default_thumbnail_text_input_urls
...
def state_init():
    ...
    if "thumbnail_text_input_urls" not in st.session_state:
